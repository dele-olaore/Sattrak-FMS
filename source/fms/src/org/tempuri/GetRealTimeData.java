 ...
 *         &lt;element name="lastGMTUpdateTime" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "GetRealTimeData")
public class GetRealTimeData {
    ...
    @XmlElementRef(name = "lastGMTUpdateTime", namespace = "http://tempuri.org/", type = JAXBElement.class, required = false)
    protected JAXBElement<String> lastGMTUpdateTime;
    ...
    /**
     * Gets the value of the lastGMTUpdateTime property.
     * 
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public JAXBElement<String> getLastGMTUpdateTime() {
        return lastGMTUpdateTime;
    }

    /**
     * Sets the value of the lastGMTUpdateTime property.
     * 
     * @param value
     *     allowed object is
     *     {@link JAXBElement }{@code <}{@link String }{@code >}
     *     
     */
    public void setLastGMTUpdateTime(JAXBElement<String> value) {
        this.lastGMTUpdateTime = value;
    }
